...
class Normalizer(torch.nn.Module):
    def __init__(self,
        ...
        self._acc_count = torch.tensor(0)
        self._num_accumulations = torch.tensor(0)
        self._acc_sum = torch.zeros(size)
        self._acc_sum_squared = torch.zeros(size)
    ...
    def _mean(self):
        safe_count = torch.maximum(self._acc_count, 1.0)
